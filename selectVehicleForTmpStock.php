...
$lin = "getVehiclePageLoader()";

$basic = new basic;
$basic->menuBar("TMP Stock - Select Vehicle",$lin);
$basic->modal();
	...
	<div class="divList card-deck mb-3 text-center " style="background-color: white;color: black;border: 1px solid black">
        <div class="card mb-4 shadow-sm">
          ...
          <div class="card-body">
			...
			<button class="btn btn-primary btn-lg" onclick="ajaxCommonGetFromNet('<?php echo($url) ?>unloadStock.php?$vehicleId=<?php echo($row['id']) ?>','mainStage')">View</button>
